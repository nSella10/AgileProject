...
const PricingPage = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "We accept all major credit cards, PayPal, and bank transfers for institutional customers."
    },
    {
      question: "Do you offer discounts for non-profits?",
      answer: "Yes, we offer special pricing for qualified educational institutions and non-profit organizations. Contact us for details."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
        ...
        <div className="bg-gray-50 rounded-lg p-8 text-center mb-16">
          ...
          <p className="text-gray-700 mb-6 max-w-2xl mx-auto">
            For large enterprises, school districts, or organizations with specific needs, 
            we offer custom solutions tailored to your requirements.
          </p>
