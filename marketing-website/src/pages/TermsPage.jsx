        ...
        <div className="prose prose-lg max-w-none">
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              By accessing and using Guessify! ("the Service"), you accept and
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Guessify! is an interactive music quiz platform that allows users
              to create, host, and participate in music-based educational games.
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              are owned by Guessify! and are protected by international
              copyright, trademark, patent, trade secret, and other intellectual
              property laws.
            </p>
            <p className="text-gray-700 mb-4">
              Music content is licensed for educational use only. Users may not
              download, distribute, or use music content outside of the
              platform.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              In no event shall Guessify!, its directors, employees, partners,
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              ...
              Service. Continued use of the Service after such modifications
