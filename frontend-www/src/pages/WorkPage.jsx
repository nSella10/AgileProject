  ...
  const features = [
    {
      icon: FaUsers,
      title: "Team Building",
      description: "Strengthen team bonds through fun, collaborative music challenges that bring colleagues together."
    },
    {
      icon: FaHandshake,
      title: "Corporate Events",
      description: "Perfect for company parties, team retreats, and corporate entertainment that everyone will remember."
    },
    {
      icon: FaLightbulb,
      title: "Creative Breaks",
      description: "Boost creativity and productivity with engaging music breaks that refresh and energize your team."
    },
    {
      icon: FaChartLine,
      title: "Performance Analytics",
      description: "Track team engagement and participation with detailed analytics and performance insights."
    }
  ];
  ...
  const useCases = [
    {
      ...
      description: "Regular team building activities that strengthen workplace relationships"
    },
    {
      title: "Corporate Events",
      description: "Entertainment for company parties, conferences, and special occasions"
    },
    {
      title: "Lunch & Learn",
      description: "Fun educational breaks that combine learning with entertainment"
    },
    {
          ...
          <div className="relative max-w-7xl mx-auto px-6 py-20 lg:py-32">
            <div className="text-center">
              ...
              <p className="text-xl lg:text-2xl mb-8 text-orange-100 max-w-3xl mx-auto">
                Build stronger teams through engaging music activities that boost morale, creativity, and collaboration in the workplace.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Discover how Guessify! creates meaningful connections and boosts team performance through shared musical experiences.
              </p>
            </div>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-xl text-gray-600 mb-8">
                  Transform your workplace culture with activities that bring measurable improvements to team dynamics and productivity.
                </p>
              ...
              <div className="bg-gradient-to-br from-orange-50 to-red-50 p-8 rounded-2xl border border-orange-100">
                <div className="text-center">
                  ...
                  <p className="text-gray-600 mb-6">
                    Join companies worldwide who are using Guessify! to create stronger, more connected teams.
                  </p>
                  <button
                    onClick={() => navigate("/register")}
        ...
        <div className="py-20 bg-gradient-to-r from-orange-600 to-red-600 text-white">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <p className="text-xl text-orange-100 mb-8">
              Create a more connected, creative, and productive team through the power of music.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button
                onClick={() => navigate("/register")}
