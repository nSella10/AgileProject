    ...
    <PageLayout>
      <div className="bg-gradient-to-b from-indigo-600 to-purple-700 py-16 text-white">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Solutions for Every Setting</h1>
          <p className="text-xl text-indigo-200 max-w-3xl mx-auto">
            Discover how Guessify! can enhance learning, team building, and entertainment 
      ...
      <div className="max-w-7xl mx-auto px-4 py-16">
          ...
          {solutions.map((solution, idx) => (
            <div key={idx} className="bg-white rounded-lg shadow-lg p-8">
              <div className="flex items-center mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-800">{solution.title}</h2>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {useCases.map((useCase, idx) => (
              <div key={idx} className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-xl font-bold mb-4 text-indigo-700">{useCase.category}</h3>
                <ul className="space-y-2">
                  {useCase.examples.map((example, exampleIdx) => (
                    <li key={exampleIdx} className="text-gray-700 flex items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-lg">
              ...
              <p className="text-gray-600 text-sm mb-3">
                "Guessify! has transformed our music classes. Student engagement is up 85% 
                and test scores have improved significantly."
              </p>
              <p className="text-xs text-gray-500">- Sarah Johnson, Music Teacher</p>
            </div>
            <div className="bg-white p-6 rounded-lg">
              <h3 className="font-bold mb-2">TechCorp Inc.</h3>
              <p className="text-gray-600 text-sm mb-3">
                "Our remote team building events with Guessify! have been a huge hit. 
                Team morale and collaboration have never been better."
              </p>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Join thousands of educators, teams, and families who are already using 
            Guessify! to create memorable musical experiences.
          </p>
